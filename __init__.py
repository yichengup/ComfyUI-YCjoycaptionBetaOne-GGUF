...
try:
    ...
    try:
        ...
        try:
            ...
            if cuda_version:
                if cuda_version.startswith("11"):
                    ...
                    cuda_tag = "cu124" # 默认使用cu124
            else:
                cuda_tag = "cu124" # 如果检测不到CUDA版本，默认使用cu124
        ...
        print("CMAKE_ARGS=\"-DLLAMA_OPENMP=ON -DLLAMA_CUBLAS=ON\" pip install llama-cpp-python==0.3.4 --no-cache-dir --extra-index-url https://abetlen.github.io/llama-cpp-python/whl/cu124")
